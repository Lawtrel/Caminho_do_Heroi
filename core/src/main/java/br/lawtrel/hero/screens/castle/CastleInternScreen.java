...
public class CastleInternScreen extends ScreenAdapter{
    ...
    private final String MAP_ID = "maps/castleIn.tmx";
    ...
    public void show(){
        ...
        if (player == null) {
            Gdx.app.error("CastleInternScreen", "Jogador nulo ao mostrar a tela!");
            return;
        }
    ...
    private Vector2 findSpawnPoint(TiledMap map){
        ...
        Gdx.app.log("CastleInternScreen", "Objeto 'spawnPoint' não encontrado na camada 'Spawn'. Usando valor padrão.");
